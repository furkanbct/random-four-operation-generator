...
* ```OperationManager.GetNewOperation(10, OperationManager.Mode.Subtraction, OperationManager.Mode.Division)``` --> Generates division or multiplication operation involving numbers from 1 to 10 etc. ```9 ÷ 3 = ?```,```10 x 8 = ?```
